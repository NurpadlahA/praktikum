...
<h2>Form Input Dosen</h1>
<?php echo form_open("dosen/save") ?>
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Nama</label> 
    <div class="col-8">
      <input id="nama" name="nama" placeholder="Silahkan Masukan Nama" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tmp_lahir" name="tmp_lahir" placeholder="Silahkan Masukan Tempat Lahir" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="nidn" name="nidn" placeholder="Silahkan Masukan NIDN" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="pendidikan" class="col-4 col-form-label">pendidikan</label> 
    <div class="col-8">
      <input id="pendidikan" name="pendidikan" placeholder="Silahkan Masukan Pendidikan" type="text" class="form-control">
    </div>
  </div> 
  <div class="form-group row">
